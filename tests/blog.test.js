...
describe('likes', () => {
    test('the sum of all likes of blogs', () => {
        const res = listHelper.likes(blogs);
        expect(res).toBe(36);
    })

    test('found the blog with more likes', () =>{
    ...
    test('find the author with the highest hight and give the sum of its likes', () =>{
      const ans = {
        author: 'Edsger W. Dijkstra',
        likes: 17
      };
